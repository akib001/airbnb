...
function Step2Option({id, name, description}) {
  ...
  return (
    <div className='mx-auto max-w-md md:max-w-lg w-full'>
              ...
              <label htmlFor={id} className="border-[1px] border-grey peer-checked:border-black peer-checked:border-2 rounded-xl pl-4 pr-3 py-6 md:py-4 flex flex-col justify-between items-start">
